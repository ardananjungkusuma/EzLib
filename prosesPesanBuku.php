...
<body>
    ...
    if ($_SESSION['status'] == 'user_login') {
        ...
        $sqlInsert = "insert into peminjaman(id_user,id_buku,tanggal_booking,tanggal_pinjam,tanggal_kembali,denda) values ('$id_user','$id_buku','$tanggalBooking','None','None','None')";
